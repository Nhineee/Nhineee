...
function SignIn({navigation}): JSX.Element {
    ...
    const onSubmitHandler = () => {
        fetch(`http://192.168.39.106:8090/api/login`, {
          method: "POST",
          headers: {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.loginButtonContainer}>
                <View>
                    <TouchableOpacity style={styles.button} onPress={(onSubmitHandler)=>navigation.navigate('home')}><Text style={{ color: 'white' }} >Sign In</Text></TouchableOpacity>
                </View>
