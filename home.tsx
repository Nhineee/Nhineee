...
function Home(): JSX.Element {
    ...
    useEffect(() => {
        ...
        fetch('http://192.168.39.102:8090/api/task')
    ...
    const updateTask = () => {
        fetch(`http://192.168.39.102:8090/api/task/${modalTaskId}`, {
            method: 'PUT',
            headers: {
                    ...
                    <View style={[styles.centeredViewAdd, { borderRadius: 40, borderColor: 'white' }]}>
                        ...
                        <View style={styles.warpContainer}>
                            <ScrollView>
                                ...
                                <View style={[styles.inputStyle, { height: 680, borderRadius: 40, borderColor: 'white' }]}>
                                    <KeyboardAvoidingView
                    ...
                    <View style={styles.centeredViewAdd}>
                        ...
                        <View style={[styles.warpContainer, { borderRadius: 40, borderColor: 'white' }]}>
                            <ScrollView>
                                ...
                                <View style={[styles.inputStyle, { height: 260 }]}>
                                    <KeyboardAvoidingView
                                        behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
                                ...
                                <View style={[styles.inputStyle, { height: 165 }]}>
                                    <KeyboardAvoidingView
                                        behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
                                        <TextInput style={{ color: 'white' }}
